...
object Driver{
  ...
  def main(args:Array[String]){
    ...
    //Dot product
    val res1=F2016A7PS0110P.dotProduct(kernel1,kernel2)

    // // println(prod)
    // //convolution 
    val res2=F2016A7PS0110P.convolute(image,kernel1,imagesize,kernel1size) 

    // // println(result)

    // //activation 
    val res3=F2016A7PS0110P.activationLayer((x:Double)=>if(x>150) x else 0,image) 
